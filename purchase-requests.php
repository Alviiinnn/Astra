...
<body class="c-bg-khaki">
    ...
    <div class="container c-bg-khaki">
        <div class="d-flex">
            <button class="btn btn-success col-lg-2" id="addRequest" data-bs-toggle="modal"
                data-bs-target="#modalPurchaseReq">Add Request</button>

            <select id="statusFilter" class="form-select mb-4 col-lg-2" style="width: 10em;">
        ...
        <table id="table_main"
            class="table table-hover table-searchable sticky-sm-top sticky-md-top sticky-lg-top sticky-xl-top sticky-xxl-top ">
            <thead>
                <tr>
                    <th>#</th>
    ...
    <div class="modal fade" id="modalPurchaseReq" tabindex="-1" aria-labelledby="modalPurchaseReqLabel"
                ...
                <div class="modal-body container">
                    <div class="container p-4" role="child">
                        <div class="row align-items-center pb-3">
                            <label class="col-lg-2" for="purchase_req_num">Purchase Request No.:</label>
                            <div class="col-lg-3">
                                <input class="form-control" id="purchase_req_num" type="text" name="purchase_req_num"
                                    placeholder="e.g. EA41-B9-001" />
                            </div>
                            <span class="col-lg-2 small text-danger d-none" name="purchase_req_warning">This is a
                                required field!</span>
                        </div>
                        <div class="row">
                            <table id="table_form" class="table table-bordered table-responsive align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td contenteditable data-col="item" data-required="1"></td>
                                        <td contenteditable data-int="1" data-col="qty"></td>
                                        ...
                                        <td data-int="1" data-col="amount">0</td>
                                        <td data-dropdown="1" data-col="brand">
                                            <select class="form-select border-0">
                                        ...
                                        <td contenteditable data-col="remarks"></td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="row align-items-center mb-2">
                            ...
                            <div class="col-lg-11 d-flex">
                                <div class="form-floating">
                                    <input id="iphase" name="phase" type="text" class="form-control">
                                    <label for="iphase">Phase</label>
                                </div>
                                <div class="form-floating ms-1">
                                    <input id="iblock" name="block" type="text" class="form-control">
                                    <label for="iblock">Block</label>
                                </div>
                                <div class="form-floating ms-1">
                                    <input id="ilot" name="lot" type="text" class="form-control">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body container">
                    <div class="container p-4" role="child">
                        ...
                        <div class="row">
                            <table id="table_details" class="table table-bordered table-responsive align-middle">
                                <thead class="table-light">
                                    <!-- <th>#</th> -->
                                    <th style="width: 20em;">Item</th>
                                    <th>Qty</th>
                                ...
                                <tbody>
                                    <tr>
                                        <!-- <td>1</td> -->
                                        <td data-col="item" data-required="1"></td>
                                        <td data-int="1" data-col="qty"></td>
                                        <td data-dropdown="1" data-col="uom">
                                        ...
                                        <td data-dropdown="1" data-col="status">
                                            <!-- <select class="form-select">
                        ...
                        <div class="row align-items-center mb-2">
                            ...
                            <div class="col-lg-11 d-flex">
                                <div class="form-floating">
                                    <input id="details_phase" name="details_phase" type="text" class="form-control" disabled />
                                    <label for="details_phase">Phase</label>
                                </div>
                                <div class="form-floating ms-1">
                                    <input id="details_block" name="details_block" type="text" class="form-control" disabled />
                                    <label for="details_block">Block</label>
                                </div>
                                <div class="form-floating ms-1">
                                    <input id="details_lot" name="details_lot" type="text" class="form-control" disabled />
