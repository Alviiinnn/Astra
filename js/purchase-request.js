...
$("td[data-col=qty], td[data-col=unitcost]").keydown(function (event) {
...
$("td[data-col=qty]").keyup(function () {
    var qty = $(this).text();
...
$("td[data-col=unitcost]").keyup(function () {
...
$("button[name=addRow]").click(() => {
    ...
    row += "<td contenteditable data-int='1' data-col='amount'>0</td>";
    row += "<td data-dropdown='1' data-col='brand'>";
    row += "    <select class='form-select border-0'>";
...
$("button[name=modify]").click(() => {
    ...
    var brand_dropdown = `<select class="form-select border-0">
    ...
    $("#table_details td[data-col=brand]").text("").append(brand_dropdown);
