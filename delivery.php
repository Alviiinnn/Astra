...
<body class="c-bg-khaki">
    ...
    <div class="container c-bg-khaki">
        <div class="row">
            <button id="addRequest" class="btn btn-success w-25" data-bs-toggle="modal" data-bs-target="#modalAddDelivery">Add Delivery</button>
    ...
    <div class="modal fade" id="modalAddDelivery" tabindex="-1" aria-labelledby="modalAddDeliveryLabel" aria-hidden="true"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body container p-5">
                    <div class="container" role="child">
                        ...
                        <div class="row">
                            <table id="table_form" class="table table-bordered table-responsive text-center">
